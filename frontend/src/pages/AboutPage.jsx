...
export default function AboutPage() {
  return (
    <>
      <PageHero
        title="О сервисе"
        subtitle="Фотографии, документы, биографии и места захоронения — в одном цифровом архиве."
      />

      <section className="section">
        <div className="section-inner narrow">
          <p className="lead">
            Здесь можно собрать биографию, семейные фотографии, место захоронения и
            генеалогическое древо. Подходит семьям, музеям памяти и городским проектам,
            которым важно, чтобы материалы не терялись в бумажных архивах и старых телефонах.
          </p>
      ...
      <section className="section" id="about-legal">
        <div className="section-inner narrow">
          ...
          <div className="legal-block" id="about-payment">
            ...
            <p className="lead">
              Базовый функционал доступен бесплатно, актуальные цены платных опций — на странице
              «Цены». Полные условия оплаты, порядок возврата и реквизиты будут опубликованы в
              договоре-оферте при запуске коммерческой версии.
            </p>
          </div>
