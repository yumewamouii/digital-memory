  ...
  return (
    <>
      <PageHero
        ...
        subtitle={
          step === "plan"
            ? "Сначала выберите формат страницы — краткую или расширенную."
            : plan === "extended"
              ? "Заполните данные расширенной страницы памяти."
              : "Заполните данные краткой страницы памяти."
        }
      />
        ...
        <div className={`section-inner${step === "plan" ? "" : " narrow"}`}>
          {!token ? (
            <div className="notice-card form-panel" style={{ margin: "0 auto" }}>
              ...
              <p className="lead">
                Для создания карточки памяти необходимо войти или зарегистрироваться.
              </p>
