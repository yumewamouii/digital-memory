...
const advantages = [
  ...
  },
  {
    ...
    text: "Начните древо бесплатно и добавляйте родственников по мере появления сведений.",
  },
  {
    title: "Музей памяти",
    text: "Смотрите примеры страниц и оформляйте биографии родственников.",
  },
  {
  ...
  return (
    <>
      <PageHero
        ...
        subtitle="Соберите родословную: родственники, даты и связи со страницами памяти. Начать можно бесплатно."
      >
      ...
      <CtaRegisterBand
        title="Начните генеалогическое древо"
        text="Зарегистрируйтесь и добавьте первых родственников бесплатно."
      />
    </>
  );
}
